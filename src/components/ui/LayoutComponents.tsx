...
export function Button({ children, variant = 'primary', className, ...props }: React.ButtonHTMLAttributes<HTMLButtonElement> & { variant?: 'primary' | 'outline' | 'danger' | 'ghost' }) {
  ...
  const variants = {
    primary: "bg-[#7A0C16] hover:bg-[#630911] text-white",
    outline: "bg-white border border-slate-200 text-slate-700 hover:bg-[#7A0C16]/5 hover:text-[#7A0C16] hover:border-[#7A0C16]/30",
