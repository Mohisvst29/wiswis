...
export default function FloatingActions() {
  ...
  return (
    <div className="animate-float" style={{ position: 'fixed', bottom: '30px', right: '30px', zIndex: 999999, display: 'flex', flexDirection: 'column', gap: '15px' }}>
      ...
      {phNumber && (
        <a href={`tel:${phNumber}`} title="اتصال مباشر" style={{ width: '56px', height: '56px', backgroundColor: 'var(--color-primary)', borderRadius: '50%', display: 'flex', alignItems: 'center', justifyContent: 'center', color: '#1a1a1a', boxShadow: '0 10px 15px -3px rgba(212, 160, 23, 0.3)' }}>
