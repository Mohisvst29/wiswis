          ...
          {slides.length > 0 && (
            slides[currentIndex].match(/\.(mp4|webm|ogg)$/i) ? (
              <motion.video
                ...
                style={{ position: 'absolute', top: 0, left: 0, width: '100%', height: '100%', objectFit: 'cover', WebkitTransform: 'translate3d(0,0,0)', transform: 'translate3d(0,0,0)', willChange: 'transform' }}
              />
            ) : (
              <motion.img
                key={currentIndex}
